...
def _get_seq(ranges, x):
	...
	seq_residues_str = ' '.join(str(e) for e in seq_residues)
	if x == 'str':
...
def get_ricci_residues(x='str'):
	...
	final_seq = _get_seq(ricci_rangeResidues, x)
	return(final_seq)

def get_pisani_residues(x='str'):
	pisiani_rangeResidues = [ [4,12], [17, 24], [29,34], [46,55], [66,71], [76,81],  
							[87,93], [101, 120], [121, 135], [140, 150], [182, 194], [277, 282]]
	final_seq = _get_seq(pisiani_rangeResidues, x)
	return(final_seq)